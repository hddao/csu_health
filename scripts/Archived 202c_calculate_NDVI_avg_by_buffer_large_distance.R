...
# 2000
list_df[1, ] %>% purrr::pwalk(.f = export_greenspace_df_long) #2002.26
list_df[2, ] %>% purrr::pwalk(.f = export_greenspace_df_long) #2274.43
list_df[3, ] %>% purrr::pwalk(.f = export_greenspace_df_long) #3904.42
list_df[4, ] %>% purrr::pwalk(.f = export_greenspace_df_long) #4487.39

# 4000
list_df[5, ] %>% purrr::pwalk(.f = export_greenspace_df_long) #7813.63
list_df[6, ] %>% purrr::pwalk(.f = export_greenspace_df_long) #8004.4
list_df[7, ] %>% purrr::pwalk(.f = export_greenspace_df_long) #14588.78
list_df[8, ] %>% purrr::pwalk(.f = export_greenspace_df_long) #14856.48
