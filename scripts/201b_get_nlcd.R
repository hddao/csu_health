...
nlcd16_e4000_raster <- raster::crop(nlcd16_raster, raster::extent(buffere4000))


# Save to tif
# raster::writeRaster(nlcd16_co_raster, "DATA/Processed/Aim2/NLCD/nlcd16_co_raster.tif", overwrite=TRUE)
raster::writeRaster(nlcd16_e4000_raster,
                    "DATA/Processed/Aim2/NLCD/aim2_nlcd16_e4000_raster.tif",
                    format="GTiff",
                    overwrite=TRUE)

raster::plot(nlcd16_e4000_raster,
             zlim = c(0, 100),
