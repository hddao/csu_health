...
save_data(aim2_desc_table_3,
          "DATA/Processed/Aim2/Agreement/aim2_desc_table_3",
          "DATA/Processed/Aim2/Agreement/Archived/aim2_desc_table_3",
          xlsx = TRUE, csv = FALSE)
...
p <- gridExtra::arrangeGrob(hist_list[[1]], hist_list[[2]], hist_list[[3]],
                            ...
                            nrow=2, ncol=3)
ggplot2::ggsave(plot = p,
                "outputs/figures/Aim2/histogram_by_radius_raster.jpg",
                device = "jpeg",
                width = 15,
                height = 10,
                units = "in")
