...
terra::writeRaster(modis_26953,
                   "DATA/Processed/Aim2/Greenspace/aim2_prep_buffer_modis_26953_summer.tif",
                   datatype = "FLT4S",
                   overwrite = TRUE)

terra::writeRaster(landsat_26953,
                   "DATA/Processed/Aim2/Greenspace/aim2_prep_buffer_landsat_26953_summer.tif",
                   datatype = "FLT4S",
                   overwrite = TRUE)

rm(modis_26953, landsat_26953)

modis_26953 <- "DATA/Processed/Aim2/Greenspace/aim2_prep_buffer_modis_26953_summer.tif"
landsat_26953 <- "DATA/Processed/Aim2/Greenspace/aim2_prep_buffer_landsat_26953_summer.tif"
...
export_greenspace_df_long <- function(buffer, raster, id_chr, id_df,
  ...
  filelocationarc <- paste0("DATA/Processed/Aim2/Greenspace/summer/Archived/aim2_greenspace_",
...
files <- tibble::tibble(filename = list.files(path = "DATA/Processed/Aim2/Greenspace/summer",
...
save_data(greenspaceall[[1]],
          "DATA/Processed/Aim2/Greenspace/aim2_greenspaceall_geometry_summer",
          "DATA/Processed/Aim2/Greenspace/Archived/aim2_greenspaceall_geometry_summer")

save_data(greenspaceall[[2]],
          "DATA/Processed/Aim2/Greenspace/aim2_greenspaceall_school_summer",
          "DATA/Processed/Aim2/Greenspace/Archived/aim2_greenspaceall_school_summer")
