...
save_data(greenspaceall[[3]],
          "DATA/Processed/Aim2/Greenspace/aim2_greenspaceall_studentkey",
          "DATA/Processed/Aim2/Greenspace/Archived/aim2_greenspaceall_studentkey")
