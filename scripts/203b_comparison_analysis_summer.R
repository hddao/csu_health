...
#                     paste0("outputs/figures/Aim2/summer/scatterplot_", month, ".jpg"),
#                     device = "jpeg",
#                     width = 9,
#                     height = 6,
#                     units = "in")
...
#           "DATA/Processed/Aim2/Agreement_summer/lmer_res_diff_1",
#           "DATA/Processed/Aim2/Agreement_summer/Archived/lmer_res_diff_1",
#           csv = FALSE)
# save_data(lmer_res,
#           "DATA/Processed/Aim2/Agreement_summer/lmer_res",
#           "DATA/Processed/Aim2/Agreement_summer/Archived/lmer_res",
#           csv = FALSE)
# save_data(lmer_info,
#           "DATA/Processed/Aim2/Agreement_summer/lmer_info",
#           "DATA/Processed/Aim2/Agreement_summer/Archived/lmer_info",
#           csv = FALSE)
...
#   save_data(boot_data,
#             paste0("DATA/Processed/Aim2/Agreement_summer/Bootstrap/boot_data_", B),
#             paste0("DATA/Processed/Aim2/Agreement_summer/Bootstrap/Archived/boot_data_", B),
#             csv = FALSE)
#   tictoc::toc()
#   gc()
#   boot_data
...
files_df <- tibble::tibble(files_res_sum = list.files(path = "DATA/Processed/Aim2/Agreement_summer/Bootstrap/",
                           ...
                           files_res_diff_sum = list.files(path = "DATA/Processed/Aim2/Agreement_summer/Bootstrap/",
                                                           pattern = "^res_diff_sum_\\d{3}\\.rds$",
                                                           full.names = TRUE) %>% sort(),
                           files_res_diff_1_sum = list.files(path = "DATA/Processed/Aim2/Agreement_summer/Bootstrap/",
...
files <- list.files(path = "DATA/Processed/Aim2/Agreement_summer/Bootstrap/agreement_stat/",
...
#
# save_data(lmer3_res,
#           "DATA/Processed/Aim2/Agreement_summer/lmer3_res",
#           "DATA/Processed/Aim2/Agreement_summer/Archived/lmer3_res",
#           csv = FALSE)
